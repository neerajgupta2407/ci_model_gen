...
		$param['category_name'] = $this->category_name;
...
		if($param['c_id'] != ''){ $this->c_id = $param['c_id']; }
		if($param['category_name'] != ''){ $this->category_name = $param['category_name']; }
		if($param['dt'] != ''){ $this->dt = $param['dt']; }
 	} 

	function fetch_data()
	{
		$param['c_id'] = $this->c_id;
